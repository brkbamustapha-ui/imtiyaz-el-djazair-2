...
export const SECTION_TYPES: SectionTypeDefinition[] = [
  {
    ...
    fields: [
      ...
      { name: "backgroundImage", label: "Background image", type: "image", group: "Background", showWhen: { field: "backgroundType", equals: "image" } },
      {
        ...
        type: "select",
        group: "Background",
        showWhen: { field: "backgroundType", equals: "image" },
        options: [
        ...
        help: "Which part of the photograph stays in frame when it is cropped.",
      },
    ...
    defaults: {
      ...
      backgroundImage: "/assets/banner/hero-students.jpg",
